createLocalizationString({
	readable = "You can search the ATT Database by using a item filter.",
	constant = "ITEM_FILTER_DESCRIPTION",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Вы можете отфильтровать предметы в ATT при помощи фильтра.",
		-- TODO: ko = "",
		cn = "你可以通过使用物品过滤来搜索 ATT 数据库。",
		tw = "你可以通過使用物品篩選來搜尋 ATT 資料庫。",
	},
})