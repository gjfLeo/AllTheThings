createLocalizationString({
	...
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную настройку, если Вы хотите отслеживать весь лут.\n\nВы можете отрегулировать отображаемый лут на вкладке Фильтры.",
		-- TODO: ko = "",
		cn = "启用此选项可以显示来自所有来源的战利品。\n\n您可以根据“过滤器”标签更改显示的战利品类型。",
		tw = "啟用此選項可以顯示來自所有來源的戰利品。\n\n您可以依據“篩選器”標籤更改顯示的戰利品類型。",
	},
})