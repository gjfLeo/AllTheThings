createLocalizationString({
	readable = "These are World Quests and other time-limited Things that are currently available somewhere. Go get 'em!",
	constant = "WORLD_QUESTS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Эти Локальные Задания и другие ограниченные по времени Штучки сейчас доступны где-либо. Получи их!",
		-- TODO: ko = "",
		cn = "这些都是世界任务和其他有时间限制的事物，目前可以在某个地方获得。去得到他们！",
		tw = "這些都是世界任務和其他有時間限制的事物，目前可以在某個地方獲得。去得到他們！",
	},
})