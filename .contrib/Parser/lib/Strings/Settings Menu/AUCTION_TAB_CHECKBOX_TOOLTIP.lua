createLocalizationString({
	readable = "Enable this option if you want to see the Auction House Module provided with ATT.\n\nSome addons are naughty and modify this frame extensively. ATT doesn't always play nice with those toys.",
	constant = "AUCTION_TAB_CHECKBOX_TOOLTIP",
	export = true,
	text = {
