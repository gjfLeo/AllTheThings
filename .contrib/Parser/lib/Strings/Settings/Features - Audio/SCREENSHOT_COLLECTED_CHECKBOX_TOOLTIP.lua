createLocalizationString({
	readable = "Enable this option if you want to take a screenshot for every Thing you collect.",
	constant = "SCREENSHOT_COLLECTED_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную опцию, если Вы хотите делать скриншот, когда Вы получаете новую Штучку.",
		-- TODO: ko = "",
		cn = "如果你想为你收藏的每件物品进行截图请启用此选项。",
		tw = "如果你想為你收藏的每件物品進行截圖請啟用此選項。",
	},
})