createLocalizationString({
	readable = "Enable this option if you want only visible ATT windows to be updated.\n\nThis can greatly reduce loading times and prevent large framerate spikes in some situations.",
	constant = "ADHOC_UPDATES_CHECKBOX_TOOLTIP",
	export = true,
	text = {
