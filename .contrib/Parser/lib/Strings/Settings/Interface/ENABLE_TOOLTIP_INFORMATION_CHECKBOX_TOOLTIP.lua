createLocalizationString({
	readable = "Enable this option if you want to see the information provided by ATT in external tooltips. This includes item links sent by other players, in the auction house, in the dungeon journal, in your bags, in the world, on NPCs, etc.\n\nIf you turn this feature off, you are seriously reducing your ability to quickly determine if you need to kill a mob or learn an appearance.\n\nWe recommend you keep this setting on.",
	constant = "ENABLE_TOOLTIP_INFORMATION_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную опцию, если Вы хотите видеть информацию ATT во всплывающих подсказках. Включает в себя подсказки в ссылках на предметов от других игроков, предметы на аукционе, в путеводителе по приключениям, в Ваших сумках, в мире, над НИПами и т.п.\n\nЕсли Вы выключите данную функцию, Вы серьёзно снизите Вашу возможность быстро определить, нужно ли убить моба или изучить данный облик.\n\nМы рекомендуем оставить эту опцию включённой.",
		-- TODO: ko = "",
		cn = "如果希望在鼠标提示中查看 ATT 提供的信息，请启用此选项。这包括其他玩家发送的物品链接，在拍卖行、在地下城助手、在你的包里、在世界、在 NPC 等等。\n\n如果你关闭了这个功能，就会严重降低你快速判断是否需要击杀首领或学习外观的能力。\n\n我们建议你保持此设置。",
		tw = "如果希望在指標提示中查看 ATT 提供的資訊，請啟用此選項。這包括其他玩家發送的物品連接，在拍賣行、在地城助手、在你的背包裡、在世界、在 NPC 等等。\n\n如果你關閉了這個功能，就會嚴重降低你快速判斷是否需要擊殺首領或學習外觀的能力。\n\n我們建議你保持此設定。",
	},
})