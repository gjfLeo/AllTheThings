createLocalizationString({
	readable = "This has a limited quantity and may not always be present on the vendor.",
	constant = "LIMITED_QUANTITY",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Предмет имеется в ограниченном количестве и может не всегда быть доступен у торговца.",
		-- TODO: ko = "",
		cn = "此物品有数量限制，在商人处并非总是可见。",
		tw = "此物品有數量限制，在商人處並非總是可見。",
	},
})