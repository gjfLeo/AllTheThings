createLocalizationString({
	...
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную опцию, если Вы хотите автоматически разворачивать заголовки текущей сложности в мини списке, когда Вы входите в подземелье или рейд.\n\nПример: Разворачивать только Героический заголовок, когда в Героической сложности подземелья.",
		-- TODO: ko = "",
		cn = "启用此选项后，在进入地下城或团队副本时，迷你列表中将仅自动展开与当前激活难度相匹配的难度标题。\n\n示例：当进入英雄难度地下城时，仅展开英雄难度标题。",
