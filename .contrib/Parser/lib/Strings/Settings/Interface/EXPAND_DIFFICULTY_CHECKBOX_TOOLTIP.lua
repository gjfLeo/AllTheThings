createLocalizationString({
	readable = "Enable this option if you want to automatically expand only the matching difficulty header(s) in the mini list which correspond to the active difficulty when entering a dungeon or raid.\n\nExample: Expand only the Heroic header when entering a Heroic difficulty dungeon.",
	constant = "EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		-- TODO: ru = "Включите данную опцию, если Вы хотите автоматически минимизировать заголовки в мини списке, которые не активны, когда Вы входите в подземелье или рейд.\n\nПример: Минимизировать Героический заголовок, когда в Обычной сложности подземелья.",
		-- TODO: ko = "",
		-- TODO: cn = "如果要在进入地下城或团队副本时自动最小化小列表中未激活的难度标题，请启用此选项。\n\n比如：在普通难度地下城中最小化英雄标题。",
		-- TODO: tw = "如果要在進入地城或團隊副本時自動最小化小列表中未啟動的難度標題，請啟用此選項。\n\n比如：在普通難度地城中最小化英雄標題。",
	},
})
