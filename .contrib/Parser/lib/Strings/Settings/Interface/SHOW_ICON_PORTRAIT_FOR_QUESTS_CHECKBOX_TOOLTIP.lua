createLocalizationString({
	readable = "Enable this option if you want to see creature icon portraits instead of the default icons for quest object types.\n\nIE: When looking at quests, this option will show the face of the quest giver instead of the quest type icon.\n\nDefault: On",
	constant = "SHOW_ICON_PORTRAIT_FOR_QUESTS_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "如果你想看到生物图标头像而不是任务对象类型的默认图标，请启用此选项。\n\n也就是说：查看任务时，此选项将显示任务给予者的脸，而不是任务类型图标。\n\n默认：开启",
		tw = "如果你想看到生物圖標頭像而不是任務對象類型的預設圖標，請啟用此選項。\n\n也就是說：查看任務時，此選項將顯示任務給予者的頭像，而不是任務類型圖標。\n\n預設：開啟",
	},
})