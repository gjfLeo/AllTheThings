createLocalizationString({
	readable = "Enable this option to calculate various drop chance information in the tooltip for an item in an ATT window.\nThis can be helpful for knowing which Loot Spec should be used when Bonus Rolling for an item.",
	constant = "DROP_CHANCES_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную опцию, если Вы хотите видеть шанс выпадения в подсказке.\nМожет быть полезно для выбора специализации при Бонусном Броске.",
		-- TODO: ko = "",
		cn = "启用此选项可在 ATT 窗口的工具提示中计算物品的各种掉落几率信息。\n这有助于了解在额外投骰物品时应使用哪种拾取专精。",
		tw = "啟用此選項可在 ATT 視窗的工具提示中計算物品的各種掉落機率資訊。\n這有助於了解在額外投骰物品時應使用哪種拾取專精。",
	},
})