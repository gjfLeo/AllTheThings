createLocalizationString({
	readable = "Enable this option if you want to see a list of all of the recipes that can be crafted by any of your characters for a reagent in its tooltip.",
	constant = "SHOW_RECIPES_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "如果您想在鼠标提示中看到任何角色可以用某种材料制作的所有配方列表，请启用此选项。",
		tw = "如果您想在指標提示中看到任何角色可以用某種材料製作的所有配方列表，請啟用此選項。",
	},
})