createLocalizationString({
	readable = "Use this to customize the size of the Minimap Button.\n\nDefault: 36",
	constant = "MINIMAP_SLIDER_TOOLTIP",
	export = true,
	text = {
		...
		ru = "Используйте для установления желаемого размера Кнопки Миникарты.\n\nПо умолчанию: 36",
		-- TODO: ko = "",
		cn = "使用此选项可自定义小地图按钮的大小。\n\n默认：36",
		tw = "使用此選項可自訂小地圖按鈕的大小。\n\n預設：36",
	},
})