createLocalizationString({
	readable = "[icon:Currency] Used as a currency\n[icon:Interface_Reagent] Used as a crafting reagent\n[icon:Interface_Catalyst] Convertible at the Catalyst for a new appearance\n[icon:Interface_Upgrade] Can be upgraded for a new appearance",
	constant = "ICON_LEGEND_MISC_TEXT",
