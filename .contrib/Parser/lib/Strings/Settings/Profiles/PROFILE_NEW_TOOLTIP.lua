createLocalizationString({
	readable = "Create a blank Profile to be used by the current Character",
	constant = "PROFILE_NEW_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Создать пустой Профиль для использования текущим персонажем",
		-- TODO: ko = "",
		cn = "为当前角色创建一个空白配置文件",
		tw = "為當前角色創建一個空白設定檔",
	},
