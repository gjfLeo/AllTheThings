createLocalizationString({
	readable = "NOTE: At this time, official support is not provided by WoW's API, but ATT can track items or quest completion to make it functional in the addon.",
	constant = "UNOFFICIAL_SUPPORT_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "注意：目前，WoW 的 API 不提供官方支持，但 ATT 可以跟踪物品或任务完成情况，以使其在插件中发挥作用。",
		tw = "注意：目前，WoW 的 API 不提供官方支援，但 ATT 可以追蹤物品或任務完成情況，以使其在插件中發揮作用。",
	},
})