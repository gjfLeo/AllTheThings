createLocalizationString({
	readable = "Companion pets can be collected on multiple characters and realistically would require that you have an insane amount of bag space in order to collect them all on one character.\n\nWe recommend you keep this turned on, but you do you fam.",
	constant = "ACCOUNT_WIDE_BATTLE_PETS_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "伙伴宠物可在多个角色上收集，并且实际上需要你拥有大量的背包空间才能将它们全部收集在一个角色上。\n\n我们建议您保持此功能开启，但你可以自己刷。",
		tw = "伙伴寵物可在多個角色上收集，並且實際上需要你擁有大量的背包空間才能將它們全部收集在一個角色上。\n\n我們建議您保持此功能開啟，但你可以自己刷。",
	},
})