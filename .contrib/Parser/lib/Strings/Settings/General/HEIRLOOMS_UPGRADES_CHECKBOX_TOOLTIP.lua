createLocalizationString({
	readable = "Enable this option to specifically track collection of individual Heirloom Upgrades.\n\nWe all know Blizzard just loves to drain your gold and your soul, so keep track of that with this toggle.",
	constant = "HEIRLOOMS_UPGRADES_CHECKBOX_TOOLTIP",
	export = true,
	text = {
