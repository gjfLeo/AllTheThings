createLocalizationString({
	readable = "Recipes are not normally tracked Account-Wide in Blizzard's database, but we can do that.\n\nIt is impossible to collect them all on one character, so with this, you can give your alts and their professions meaning.",
	constant = "ACCOUNT_WIDE_RECIPES_TOOLTIP",
	export = true,
	text = {
