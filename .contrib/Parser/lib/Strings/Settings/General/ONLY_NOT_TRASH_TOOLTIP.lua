createLocalizationString({
	readable = "Enable this option to ignore white/grey items. Blizzard does not yet provide API for it in Classic.",
	constant = "ONLY_NOT_TRASH_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "启用此选项可忽略白色/灰色物品。暴雪尚未在经典怀旧服中提供 API。",
		tw = "啟用此選項可忽略白色/灰色物品。暴雪尚未在經典懷舊服中提供 API。",
	},
})