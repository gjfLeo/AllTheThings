createLocalizationString({
	readable = "Enable this setting to show all seasonal events, instead of only currently active seasonal events.\n\nNOTE: Seasonal Events will automatically be visible as active 7 days in advance.",
	constant = "SHOW_ALL_SEASONAL_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите это настройку для отображения всех Праздничных Событий вместо активных на текущий момент.\n\nПРИМЕЧАНИЕ: Праздничные События становятся видны за 7 дней до начала.",
		-- TODO: ko = "",
		cn = "启用此设置可显示所有季节性事件，而不是仅显示当前活动的季节性事件。\n\n注意：季节性活动将提前7天自动显示为活动状态。",
		tw = "啟用此設定可顯示所有季節性事件，而不是僅顯示當前活動的季節性事件。\n\n注意：季節性活動將提前7天自動顯示為活動狀態。",
	},
})