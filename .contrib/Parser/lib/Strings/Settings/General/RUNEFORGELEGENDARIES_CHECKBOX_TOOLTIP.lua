createLocalizationString({
	readable = "Enable this option to track Shadowlands Runecarving Powers.",
	constant = "RUNEFORGELEGENDARIES_CHECKBOX_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите для отслеживания Легендарных предметов Тёмных Земель.",
		-- TODO: ko = "",
		cn = "启用此选项以追踪暗影国度的符文铭刻之力。",
		tw = "啟用此選項以追蹤暗影之境的符文銘刻之力。",
	},
})