createLocalizationString({
	readable = "Turn this setting on if you want to see Account Mode data only for races and classes of your current faction.",
	constant = "FACTION_MODE_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную настройку, если Вы хотите отслеживать Штучки в Режиме Аккаунта только для рас и классов Вашей текущей фракции.",
		-- TODO: ko = "",
		cn = "如果你想只看到你当前阵营的种族和职业的战网模式数据，请开启此设置。",
		tw = "如果你想只看到你當前陣營的種族和職業的戰隊模式資料，請開啟此設定。",
	},
})