createLocalizationString({
	readable = "Unique Mode disables Sources, marking gear as collected when you have learned their unique appearance.",
	constant = "PRESET_UNIQUE",
	export = true,
	text = {
		...
		-- TODO: ru = "",
		-- TODO: ko = "",
		cn = "独特外观模式禁用来源，当你学习了它们的独特外观时，将装备标记为已收藏。",
		-- TODO: tw = "",
	},
})