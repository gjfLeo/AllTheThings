createLocalizationString({
	readable = "Click this button to copy the URL to get to my Twitch Channel.\n\nYou can ask questions while I'm streaming and I will try my best to answer them!",
	constant = "TWITCH_BUTTON_TOOLTIP",
	export = true,
	text = {
