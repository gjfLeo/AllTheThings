createLocalizationString({
	readable = "Enable this setting to forcibly show %s content even if it is not available to the current character.",
	constant = "CUSTOM_FILTERS_GENERIC_TOOLTIP_FORMAT",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную настройку, чтобы всегда показывать %s, даже если это недоступно на данном персонаже.",
		-- TODO: ko = "",
		cn = "启用此设置可强行显示%s内容，即使该内容对当前角色不可用。",
		tw = "啟用此設定可強行顯示%s內容，即使該內容對當前角色不可用。",
	},
})
