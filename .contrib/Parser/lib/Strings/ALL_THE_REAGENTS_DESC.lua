createLocalizationString({
	readable = "All items that can be used to craft an item using a profession on your account.",
	constant = "ALL_THE_REAGENTS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Все предметы, что могут быть использованы в создании предмета на Вашем аккаунте.",
		-- TODO: ko = "",
		cn = "所有你的战网上的专业制作的可以使用的物品。",
		tw = "所有你的戰隊上的專業製作的可以使用的物品。",
	},
})