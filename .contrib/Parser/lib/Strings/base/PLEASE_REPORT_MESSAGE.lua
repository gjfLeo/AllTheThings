createLocalizationString({
	readable = "Please report this to the ATT Discord in #retail-errors! Thanks!",
	...
	text = {
		...
		ru = "Пожалуйста, сообщите об этом на Discord-сервере ATT в канале #retail-errors! Спасибо!",
		-- TODO: ko = "",
		cn = "请把错误报告给 ATT Discord 的 #retail-errors！谢谢！",
		tw = "請把錯誤回報給 ATT Discord 的 #retail-errors！謝謝！",
	},
})