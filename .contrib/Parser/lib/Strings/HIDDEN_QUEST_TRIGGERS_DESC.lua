createLocalizationString({
	readable = "These are Quests which have been manually determined to trigger based on specific criteria and are mainly used internally by the game for tracking purposes",
	constant = "HIDDEN_QUEST_TRIGGERS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Эти Задания, которые срабатывают основываясь на определённых критериях, в основном используются внутри игры в целях отслеживания",
		-- TODO: ko = "",
		cn = "这些任务是根据特定的标准手动确定触发的任务，主要用于游戏内部的追踪目的",
		tw = "這些任務是依據特定的標準手動確定觸發的任務，主要用於遊戲內部的追蹤目的",
	},
})