createLocalizationString({
	readable = "Reagent Cache is out-of-date and will be re-cached when opening your professions!",
	constant = "REAGENT_CACHE_OUT_OF_DATE",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Кэш реагентов устарел и будет обновлен, когда откроете Ваши профессии!",
		-- TODO: ko = "",
		cn = "缓存已过期，打开专业界面后会重新缓存！",
		tw = "快取已過期，打開專業技能介面後會重新快取！",
	},
})