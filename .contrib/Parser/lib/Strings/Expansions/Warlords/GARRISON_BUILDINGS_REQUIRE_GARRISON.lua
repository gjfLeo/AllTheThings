createLocalizationString({
	readable = "Due to a Blizzard API issue/restriction, this can only be properly cached as collected while within your Garrison",
	constant = "GARRISON_BUILDINGS_REQUIRE_GARRISON",
	export = true,
	text = {
