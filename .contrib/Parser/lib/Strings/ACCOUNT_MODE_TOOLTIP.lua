createLocalizationString({
	readable = "Turn this setting on if you want to track all of the Things for all of your characters regardless of class and race filters.\n\nUnobtainable filters still apply.",
	constant = "ACCOUNT_MODE_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную настройку, если Вы хотите отслеживать Штучки для всех Ваших персонажей, независимо от фильтров расы и класса.\n\nФильтры Недоступных по-прежнему применяются.",
		-- TODO: ko = "",
		cn = "如果要追踪所有角色的所有内容，而不考虑职业和种族筛选，请启用此设置。\n\n不可获得过滤仍然适用。",
		tw = "如果要追蹤所有角色的所有內容，而不考慮職業和種族篩選，請啟用此設定。\n\n無法獲得篩選仍然適用。",
	},
})