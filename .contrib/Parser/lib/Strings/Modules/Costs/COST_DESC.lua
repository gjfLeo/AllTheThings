createLocalizationString({
	readable = "This contains the visual breakdown of what is required to obtain or purchase this Thing",
	constant = "COST_DESC",
	export = true,
	text = {
		...
		ru = "Содержит визуальную справку о предметах, необходимых для покупки или получения данной Штучки",
		-- TODO: ko = "",
		cn = "这里面包含了获得或购买这个物品所需要的物品",
		tw = "這裡面包含了獲得或購買這個物品所需要的物品",
	},
})