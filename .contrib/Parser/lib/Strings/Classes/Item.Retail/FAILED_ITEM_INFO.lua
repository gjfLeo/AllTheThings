createLocalizationString({
	readable = "Failed to acquire item information. The item may be invalid or may not have been cached on your server yet.",
	constant = "FAILED_ITEM_INFO",
	export = true,
	text = {
		...
		ru = "Не удалось получить информацию о предмете. Предмет может быть неправильный или ещё не был кэширован на Вашем сервере.",
		-- TODO: ko = "",
		cn = "未能获得物品信息。该物品可能是无效的或者可能还没有被缓存在你的服务器上。",
		tw = "未能獲得物品資訊。該物品可能是無效的或者可能還沒有被快取在你的伺服器上。",
	},
})