createLocalizationString({
	readable = "This indicates whether or not you have upgraded the heirloom to a certain level.\n\nR.I.P. Gold.\n - Crieve",
	constant = "HEIRLOOMS_UPGRADES_DESC",
	export = true,
	text = {
		...
		ru = "Показывает, улучшили ли Вы наследство до определённого уровня или нет.\n\nПокойся с миром, Золото.\n - Crieve",
		-- TODO: ko = "",
		cn = "这表明你是否已经将传家宝升级到了一定的级别。\n\n安息吧…金币。\n - Crieve",
		tw = "這表明你是否已經將傳家寶升級到了一定的級別。\n\n安息吧…金幣。\n - Crieve",
	},
})