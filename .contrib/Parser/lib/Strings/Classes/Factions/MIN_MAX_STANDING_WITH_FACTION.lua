createLocalizationString({
	readable = "Requires a standing between %s and %s with %s.",
	constant = "MIN_MAX_STANDING_WITH_FACTION",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Требуется отношение между %s и %s с %s.",
		-- TODO: ko = "",
		cn = "阵营声望等级在 %s 與 %s 之间，和 %s。",
		tw = "陣營聲望等級在 %s 與 %s 之間，和 %s。",
	},
})