createLocalizationString({
	readable = "The above quests need to be completed before being able to complete the things listed below.",
	constant = "UPON_COMPLETION_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Задания выше должны быть выполнены прежде, чем Вы сможете выполнить штучки, указанные ниже.",
		-- TODO: ko = "",
		cn = "以上任务需要完成后才能够完成以下的事情。",
		tw = "以上任務需要完成後才能夠完成以下的事情。",
	},
})