createLocalizationString({
	readable = "This indicates whether or not you have acquired or purchased the heirloom yet.",
	constant = "HEIRLOOM_TEXT_DESC",
	export = true,
	text = {
		...
		ru = "Показывает, получено или нет данное наследство.",
		-- TODO: ko = "",
		cn = "显示你是否已经获得或购买了传家宝。",
		tw = "顯示你是否已經獲得或購買了傳家寶。",
	},
