createLocalizationString({
	readable = "Artifact Cache is out-of-date/inaccurate and will be re-cached when logging onto each character!",
	constant = "ARTIFACT_CACHE_OUT_OF_DATE",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Кэш Артефактов устарел и будет обновлен, когда перелогинитесь!",
		-- TODO: ko = "",
		cn = "考古缓存已过时/不准确，将在登录每个角色时重新缓存！",
		tw = "考古學快取已過時/不準確，將在登錄每個角色時重新快取！",
	},
})