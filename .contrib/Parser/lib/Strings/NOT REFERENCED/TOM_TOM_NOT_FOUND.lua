createLocalizationString({
	readable = "You must have TomTom installed to plot coordinates.",
	constant = "TOM_TOM_NOT_FOUND",
	export = true,
	text = {
		...
		ru = "Нужен TomTom, чтобы ставить Указатели.",
		-- TODO: ko = "",
		cn = "必须安装 TomTom 才能绘制坐标。",
		tw = "必須安裝 TomTom 才能繪製座標。",
	},
})