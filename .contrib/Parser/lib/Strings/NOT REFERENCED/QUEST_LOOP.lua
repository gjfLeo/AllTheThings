createLocalizationString({
	readable = "Likely just broke out of an infinite source quest loop.",
	constant = "QUEST_LOOP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Скорее всего ATT вырвался из цепочки зацикленных заданий.",
		-- TODO: ko = "",
		cn = "可能刚刚从无限源任务循环中爆发出来。",
		tw = "可能剛剛從無限源任務循環中爆發出來。",
	},
})