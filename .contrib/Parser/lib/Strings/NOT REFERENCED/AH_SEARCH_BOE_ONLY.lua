createLocalizationString({
	readable = "Only Bind on Equip items can be found using this search.",
	constant = "AH_SEARCH_BOE_ONLY",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Только Персональные при Надевании предметы будут найдены при использовании данного поиска.",
		-- TODO: ko = "",
		cn = "使用此搜索只能找到装备绑定物品。",
		tw = "使用此搜尋只能找到裝備綁定物品。",
	},
