createLocalizationString({
	readable = "No cached items found in search. Expand the group and view the items to cache the names and try again. Only Bind on Equip items will be found using this search.",
	constant = "AH_SEARCH_NO_ITEMS_FOUND",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Не найдено кэшированных предметов в поиске. Расширьте группу и осмотрите предметы для кэширования имен, и попробуйте снова. Только Персональные при Надевании предметы будут найдены при использовании данного поиска.",
		-- TODO: ko = "",
		cn = "搜索中找不到缓存的物品。展开组并查看物品缓存名称，然后重试。使用此搜索只能找到BOE物品。",
		tw = "搜尋中找不到快取的物品。展開組並查看物品快取名稱，然後重試。使用此搜尋只能找到裝備綁定物品。",
	},
})
