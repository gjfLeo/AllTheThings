createLocalizationString({
	readable = "Flight paths are cached when you talk to the flight master on each continent.\n  - Crieve",
	constant = "FLIGHT_PATHS_DESC",
	export = true,
	text = {
		...
		ru = "Пути Полётов засчитываются, когда Вы говорите с Распорядителем Полётов на каждом континенте.\n  - Crieve",
		-- TODO: ko = "",
		cn = "当你与每个大陆上的飞行管理员交谈时会缓存飞行路径。\n  - Crieve",
		tw = "當你與每個大陸上的飛行管理員交談時會快取飛行路線。\n  - Crieve",
	},
})