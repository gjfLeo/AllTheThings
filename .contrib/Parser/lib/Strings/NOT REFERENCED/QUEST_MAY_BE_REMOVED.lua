createLocalizationString({
	readable = "Failed to acquire information. This quest may have been removed from the game. ",
	constant = "QUEST_MAY_BE_REMOVED",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Ошибка при получении информации. Это задание, возможно, удалено из игры. ",
		-- TODO: ko = "",
		cn = "获取信息失败。这个任务可能已从游戏中移除。",
		tw = "擷取任務資訊失敗。這個任務可能已從遊戲中移除。",
	},
})