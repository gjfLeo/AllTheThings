createLocalizationString({
	readable = "Please report this Item and where it was acquired to the ATT Discord in #retail-errors!",
	...
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Пожалуйста, сообщите в канале #retail-errors на нашем сервере Discord, где Вы нашли эту вещь!",
		-- TODO: ko = "",
		cn = "请在 ATT Discord 的 #retail-errors 中报告此物品及其获取地点！",
		tw = "請在 ATT Discord 的 #retail-errors 中回報此物品及其獲得地點！",
	},
})