createLocalizationString({
	readable = "This window allows you to randomly select a place or item to get. Go get 'em!",
	constant = "GO_GO_RANDOM_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Данное окно позволит Вам выбрать случайный предмет или место для выполнения. Получи их!",
		-- TODO: ko = "",
		cn = "此窗口允许随机选择要获取的地点或物品。去吧！",
		tw = "此視窗允許隨機選擇要獲得的地點或物品。去吧！",
	},
})