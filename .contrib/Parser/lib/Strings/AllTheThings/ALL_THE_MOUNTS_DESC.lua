createLocalizationString({
	readable = "All mounts that you have not collected yet are displayed here.",
	constant = "ALL_THE_MOUNTS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Все средства передвижения, что Вы ещё не получили, отображаются здесь.",
		-- TODO: ko = "",
		cn = "所有你尚未收藏的坐骑都会显示在这里。",
		tw = "所有你尚未收藏的坐騎都會顯示在這裡。",
	},
})