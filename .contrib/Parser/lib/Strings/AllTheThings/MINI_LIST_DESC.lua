createLocalizationString({
	readable = "This list contains the relevant information for your current zone, which cannot be found in the ATT database",
	constant = "MINI_LIST_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Этот список содержит важную информацию для текущей зоны, которая не может быть найдена в базе данных ATT",
		-- TODO: ko = "",
		cn = "该列表包含了当前区域的相关信息而这些信息在 ATT 数据库中找不到",
		tw = "該列表包含了當前區域的相關資訊而這些資訊在 ATT 資料庫中找不到",
	},
})