createLocalizationString({
	readable = "If you aren't a Blizzard Developer, it might be a good idea to uncheck this. This was done to force Blizzard to fix and/or acknowledge these bugs.",
	constant = "OPEN_AUTOMATICALLY_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Если Вы не разработчик Blizzard, то может быть хорошей идей отключить эту функцию. Это было сделано для того, чтобы заставить Blizzard исправить и/или признать данные баги.",
		-- TODO: ko = "",
		cn = "如果你不是暴雪开发者，最好是取消勾选此项。这样做是为了迫使暴雪修复和/或承认这些错误。",
		tw = "如果你不是暴雪開發者，最好是取消勾選此項。這樣做是為了迫使暴雪修復或承認這些錯誤。",
	},
})