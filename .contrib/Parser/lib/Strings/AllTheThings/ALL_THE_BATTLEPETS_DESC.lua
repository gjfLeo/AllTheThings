createLocalizationString({
	readable = "All pets that you have not collected yet are displayed here.",
	constant = "ALL_THE_BATTLEPETS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Все боевые питомцы, что Вы ещё не получили, отображаются здесь.",
		-- TODO: ko = "",
		cn = "所有你尚未收藏的宠物都会显示在这里。",
		tw = "所有你尚未收藏的寵物都會顯示在這裡。",
	},
})