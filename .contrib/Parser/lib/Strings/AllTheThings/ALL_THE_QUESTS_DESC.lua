createLocalizationString({
	readable = "All quests that have objective or starting items that can be sold on the auction house are displayed here.",
	constant = "ALL_THE_QUESTS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Все задания, которые начинаются объектом или предметом, что можно купить на аукционе, отображаются здесь.",
		-- TODO: ko = "",
		cn = "所有有目标或起始物品可以在拍卖行出售的任务都会在这里显示。",
		tw = "所有有目標或起始物品可以在拍賣行出售的任務都會在這裡顯示。",
	},
})