createLocalizationString({
	readable = "This list shows you all of the functionality related to syncing account data.",
	constant = "ACCOUNT_MANAGEMENT_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Данный список отображает весь функционал относительно синхронизации данных учётной записи.",
		-- TODO: ko = "",
		cn = "此列表显示了与同步帐号数据相关的所有功能。",
		tw = "此列表顯示了與同步帳號資料相關的所有功能。",
	},
})