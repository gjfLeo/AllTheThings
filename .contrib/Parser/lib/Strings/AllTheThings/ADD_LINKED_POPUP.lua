createLocalizationString({
	readable = "Please type the name of the character or BNET account to link to.",
	constant = "ADD_LINKED_POPUP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Пожалуйста, введите имя персонажа или учётную запись BNET для прикрепления.",
		-- TODO: ko = "",
		cn = "请输入要链接的角色或暴雪战网帐号的名称。",
		tw = "請輸入要連接的角色或暴雪戰隊帳號的名稱。",
	},
})