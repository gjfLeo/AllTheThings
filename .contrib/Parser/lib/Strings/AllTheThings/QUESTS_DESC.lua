createLocalizationString({
	readable = "Shows all possible QuestID's in the game in ascending numeric order.",
	constant = "QUESTS_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Все задания в игре в порядке возрастания номеров.",
		-- TODO: ko = "",
		cn = "按数字升序显示游戏中所有可能的任务 ID。",
		tw = "按數字升序顯示遊戲中所有可能的任務 ID。",
	},
})