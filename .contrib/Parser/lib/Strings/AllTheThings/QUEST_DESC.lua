createLocalizationString({
	readable = "Click this button to select a random quest based on what you're missing.",
	constant = "QUEST_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Нажмите эту кнопку для выбора случайного задания, основываясь на несобранных Штучках.",
		-- TODO: ko = "",
		cn = "点击此按钮可根据缺少的内容选择随机任务。",
		tw = "點擊此按鈕可依據缺少的內容選擇隨機任務。",
	},
})
