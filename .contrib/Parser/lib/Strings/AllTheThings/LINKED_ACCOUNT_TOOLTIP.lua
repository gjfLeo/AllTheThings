createLocalizationString({
	readable = "This character's account will be synchronized with automatically when they log in. For optimal play, you should whitelist a bank character and probably not your main as to not affect your ability to play your character when syncing account data.",
	constant = "LINKED_ACCOUNT_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Учётная запись данного персонажа будет автоматически синхронизироваться при входе в игру. Для оптимальной игры Вам лучше добавить персонажа-банкира, а не основного персонажа, чтобы процесс сихронизации не влиял на процесс игры на основном персонаже.",
		-- TODO: ko = "",
		cn = "此角色的帐号将在登录时自动同步。为了获得最佳游戏效果，您应该将银行角色而不是您的主要角色列入白名单，以免在同步帐户数据时影响您玩角色的功能。",
		tw = "此角色的帳號將在登錄時自動同步。為了獲得最佳遊戲效果，您應該將銀行角色而不是您的主要角色列入白名單，以免在同步帳號資料時影響您玩的角色功能。",
	},
})