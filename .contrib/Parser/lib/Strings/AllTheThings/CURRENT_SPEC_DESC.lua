createLocalizationString({
	readable = "If you switch your talents, your loot specialization changes with you.",
	constant = "CURRENT_SPEC_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Если Вы меняете Вашу Специализацию, Ваша Специализация для добычи меняется вместе с Вами.",
		-- TODO: ko = "",
		cn = "如果你改变你的专精，你的战利品就会随之改变。",
		tw = "如果你改變你的專精，你的戰利品就會隨之改變。",
	},
})