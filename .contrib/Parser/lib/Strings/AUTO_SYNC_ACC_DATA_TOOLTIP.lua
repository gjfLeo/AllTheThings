createLocalizationString({
	readable = "Enable this option if you want ATT to attempt to automatically synchronize account data between accounts when logging in or reloading the UI.",
	constant = "AUTO_SYNC_ACC_DATA_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите данную опцию, если Вы хотите, чтобы ATT пытался автоматически синхронизировать данные между учётными записями во время перезахода в игру или перезагрузки интерфейса.",
		-- TODO: ko = "",
		cn = "如果您希望 ATT 在登录或重新加载用户界面时尝试在帐号之间自动同步帐号数据，请启用此选项。",
		tw = "如果您希望 ATT 在登錄或重新載入用戶介面時嘗試在帳號之間自動同步帳號資料，請啟用此選項。",
	},
})