createLocalizationString({
	readable = "Items here exist within the game and may be available to players, but have not yet been sourced into the accurate location in ATT",
	constant = "UNSORTED_DESC_2",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Эти предметы существуют в игре и могут быть доступны игрокам, но ещё не были отсортированы в корректную секцию в ATT",
		-- TODO: ko = "",
		cn = "这里的物品存在于游戏中，玩家可能会获得，但 ATT 还没有找到准确位置",
		tw = "這裡的物品存在於遊戲中，玩家可能會獲得，但 ATT 還沒有找到準確位置",
	},
})