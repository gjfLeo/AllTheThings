createLocalizationString({
	readable = "This is likely not able to be completed by this character even using Party Sync. If you manage otherwise, please let us know on Discord!",
	constant = "DISABLE_PARTYSYNC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Скорее всего это Задание невозможно выполнить на данном персонаже даже с Синхронизацией группы. Если Вам всё же удастся, пожалуйста, сообщите нам в Discord!",
		-- TODO: ko = "",
		cn = "即使使用小队同步，这个角色也可能无法完成。如果您以其他方式管理，请在 Discord 上告诉我们！",
		tw = "即使使用隊伍同步，這個角色也可能無法完成。如果您以其他方式管理，請在 Discord 上告訴我們！",
	},
})