createLocalizationString({
	readable = "If you believe this was in error, try activating 'Debug Mode'. One of your filters may be restricting the visibility of the group.",
	constant = "NO_ENTRIES_DESC",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Если Вы уверены, что это была ошибка, попробуйте включить 'Режим Отладки'. Один из Ваших фильтов может ограничивать видимость группы.",
		-- TODO: ko = "",
		cn = "如果认为这是错误的，请尝试激活'调试模式'。某个过滤条件可能会限制该组的可见性。",
		tw = "如果認為這是錯誤的，請嘗試啟動'偵錯模式'。某個篩選條件可能會限制該組的可見性。",
	},
})