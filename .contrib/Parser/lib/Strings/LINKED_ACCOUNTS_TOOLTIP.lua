createLocalizationString({
	readable = "This shows all of the linked accounts you have defined so far.",
	constant = "LINKED_ACCOUNTS_TOOLTIP",
	export = true,
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Здесь отображаются все прикреплённые учётные записи.",
		-- TODO: ko = "",
		cn = "这将显示迄今为止定义的所有关联帐号。",
		tw = "這將顯示迄今為止定義的所有關聯帳號。",
	},
})