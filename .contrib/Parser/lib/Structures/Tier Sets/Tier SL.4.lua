SEPULCHER_OF_FIRST_ONES_TIER = {
	...
	SYM_TIER = function(ClassID, DiffID) return {{"sub","instance_tier",1195,DiffID,ClassID}} end,
}

TIER_STRUCTURE_ASSIGN_CLASSIDS(SEPULCHER_OF_FIRST_ONES_TIER)