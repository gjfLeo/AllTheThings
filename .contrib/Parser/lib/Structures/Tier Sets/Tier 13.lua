...
TIER_THIRTEEN_NORMAL_GROUPS = {	-- Dragon Soul [Tier 13] (Normal)
	cl(WARRIOR, {
		-- DPS
...
TIER_THIRTEEN_HEROIC_GROUPS = {	-- Dragon Soul [Tier 13] (Heroic)
	cl(WARRIOR, {
		-- DPS
...
TIER_THIRTEEN_GROUPS = applyclassicphase(CATA_PHASE_HOUR_OF_TWILIGHT,
