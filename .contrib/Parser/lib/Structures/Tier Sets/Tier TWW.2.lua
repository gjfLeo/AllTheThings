LIBERATION_OF_UNDERMINE_TIER = {
	...
	SYM_TIER = function(ClassID, DiffID) return {{"sub","instance_tier",1296,DiffID,ClassID}} end
}

TIER_STRUCTURE_ASSIGN_CLASSIDS(LIBERATION_OF_UNDERMINE_TIER)