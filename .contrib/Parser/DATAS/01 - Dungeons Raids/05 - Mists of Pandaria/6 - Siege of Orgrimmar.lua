...
root(ROOTS.Instances, expansion(EXPANSION.MOP, {
	applyclassicphase(MOP_PHASE_SIEGE_OF_ORGRIMMAR, inst(369, {	-- Siege of Orgrimmar
		...
		["g"] = {
			...
			d(DIFFICULTY.LEGACY_RAID.FINDER, {			-- Raid Finder (Removed with Patch 6.0.1) >> Items marked "Raid Finder" after 6.0 <<
				-- #if AFTER 6.0.1
			...
			d(DIFFICULTY.RAID.LFR, {					-- Raid Finder (Added with Patch 6.0.1)
			...
			d(CURRENT_NORMAL_PLUS_DIFFICULTIES, {		-- Flexible+ (5.4.0+) / Normal+ (6.0.1+)
			...
			FLEX_RAID_HEADER({							-- Flexible (Removed with Patch 6.0.1) >> Items marked "Normal" after 6.0 <<
				["timeline"] = { ADDED_5_4_0, REMOVED_6_0_2 },
				["ignoreBonus"] = true,
				["g"] = {
					n(ZONE_DROPS, {
			...
			d(DIFFICULTY.RAID.NORMAL, {					-- Normal (Added with Patch 6.0.1)
				["timeline"] = { ADDED_6_0_2 },
				["g"] = {
					n(ZONE_DROPS, {
						i(113224),	-- Aeth's Swiftcinder Cloak
			...
			-- #endif
			d(CURRENT_HEROIC_PLUS_DIFFICULTIES, {		-- Normal+ (5.4.0+) / Heroic+ (6.0.1+)
				cr(71865, e(869, {	-- Garrosh Hellscream
			...
			d(DIFFICULTY.LEGACY_RAID.MULTI.NORMAL, {	-- Normal (Removed with Patch 6.0.1) >> Items marked "Heroic" after 6.0 <<
				-- #if AFTER 6.0.1
			...
			d(DIFFICULTY.LEGACY_RAID.MULTI.HEROIC, {	-- Heroic (Removed with Patch 6.0.1) >> Items marked "Mythic" after 6.0 <<
				-- #if AFTER 6.0.1
			...
			d(DIFFICULTY.RAID.HEROIC, {					-- Heroic (Added with Patch 6.0.1)
				["timeline"] = { ADDED_6_0_2 },
			...
			d(DIFFICULTY.RAID.MYTHIC, {					-- Mythic (Added with Patch 6.0.1)
				["timeline"] = { ADDED_6_0_2 },
				["g"] = {
					n(ZONE_DROPS, {
						i(113224),	-- Aeth's Swiftcinder Cloak
