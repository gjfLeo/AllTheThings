...
---------------------------------------------------------------
root(ROOTS.NeverImplemented, n(SETS, {
		...
		expansion(EXPANSION.WOD, patch(2,0), bubbleDownSelf({ ["timeline"] = { CREATED_6_2_0 } }, {
			n(SEASON_PRIMAL, {
				cl(DEATHKNIGHT, {
					...
					i(127071),	-- Gladiator's Dreadplate Helm
					i(127082),	-- Gladiator's Dreadplate Gauntlets
					i(127093),	-- Gladiator's Dreadplate Shoulders
					i(127104),	-- Gladiator's Dreadplate Legguards
				}),
				cl(DRUID, {
					i(127063),	-- Gladiator's Dragonhide Robes
					i(127072),	-- Gladiator's Dragonhide Helm
					i(127083),	-- Gladiator's Dragonhide Gloves
					i(127094),	-- Gladiator's Dragonhide Spaulders
					i(127105),	-- Gladiator's Dragonhide Legguards
				}),
				cl(HUNTER, {
					i(127050),	-- Gladiator's Chain Armor
					i(127073),	-- Gladiator's Chain Helm
					i(127084),	-- Gladiator's Chain Gauntlets
					i(127095),	-- Gladiator's Chain Spaulders
				...
				cl(MONK, {
					...
					i(127075),	-- Gladiator's Ironskin Helm
					i(127086),	-- Gladiator's Ironskin Gloves
					i(127097),	-- Gladiator's Ironskin Spaulders
				...
				cl(PALADIN, {
					...
					i(127076),	-- Gladiator's Scaled Helm
					i(127087),	-- Gladiator's Scaled Gauntlets
					i(127098),	-- Gladiator's Scaled Shoulders
					i(127109),	-- Gladiator's Scaled Legguards
				}),
				cl(ROGUE, {
					i(127053),	-- Gladiator's Leather Tunic
					i(127078),	-- Gladiator's Leather Helm
					i(127089),	-- Gladiator's Leather Gloves
					i(127100),	-- Gladiator's Leather Spaulders
					i(127111),	-- Gladiator's Leather Legguards
				}),
				cl(SHAMAN, {
					i(127054),	-- Gladiator's Ringmail Armor
					i(127079),	-- Gladiator's Ringmail Helm
					i(127090),	-- Gladiator's Ringmail Gauntlets
					i(127101),	-- Gladiator's Ringmail Spaulders
			...
			n(WAR_EFFORT, {
				n(WARFRONT_BATTLE_FOR_STROMGARDE, {
					...
					filter(LEATHER, {
						...
						i(163255, {["modID"] = 5, ["ItemAppearanceModifierID"] = 0 }),	-- 7th Legionnaire's Treads
			...
			header(HEADERS.Item, 226224, {	-- Luminous Nerubian Catalyst Stone
				...
				n(PVP_GLADIATOR, bubbleDown({ ["bonusID"] = 6898 }, {
					...
					cl(HUNTER, {
						...
						i(218628),	-- Forged Gladiator's Cloak
						i(218629),	-- Forged Gladiator's Drape
						i(218630),	-- Forged Gladiator's Shawl
					}),
					cl(MAGE, {
						i(212087),	-- Ward of Violet Rebirth
						i(212088),	-- Bracelets of Violet Rebirth
