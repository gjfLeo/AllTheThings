...
root(ROOTS.Zones, m(DRAGON_ISLES, bubbleDown({ ["timeline"] = { ADDED_10_0_2_LAUNCH } }, {
	m(THALDRASZUS, {
		explorationHeader({
			...
			exploration(13867),	-- Rebellious Cliffs
			visit_exploration(13821,{coord={59.5,74.9,THALDRASZUS}}),	-- Sand-Lost Sanctum
			exploration(13894),	-- Scalewatch Caverns
			visit_exploration(13880,{coord={54.0,55.9,THALDRASZUS}}),	-- Sealed Titan Facility
			exploration(13868),	-- Serene Dreams Spa
			visit_exploration(13875,{coord={48.0,65.0,THALDRASZUS}}),	-- Shadow Ledge
			visit_exploration(13866,{coord={45.1,63.0,THALDRASZUS}}),	-- Shadow Pass
			exploration(13817),	-- Shifting Sands
			exploration(13813),	-- South Hold Gate
			exploration(13873),	-- Steelcliff Passage
			visit_exploration(13877,{coord={39.1,51.2,THALDRASZUS}}),	-- Steelcliff Rampart
			exploration(13816),	-- Stormshroud Peak
