	...
	m(EREDATH, {
		n(RARES, {
			...
			n(126869, {	-- Captain Faruq
				...
				["isDaily"] = true,
				["coord"] = { 27.6, 30.4, EREDATH },
			}),
			n(126910, {	-- Commander Xethgar
				["questID"] = 48720,	-- killID
				["isDaily"] = true,
				["coord"] = { 56.4, 15.6, EREDATH },
			}),
