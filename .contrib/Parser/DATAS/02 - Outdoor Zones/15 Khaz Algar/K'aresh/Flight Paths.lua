	...
	m(KARESH, {
		n(FLIGHT_PATHS, {
			fp(3030, {	-- Eco-Dome: Rhovan, K'aresh
				["coord"] = { 70.2, 60.9, KARESH },
				["cr"] = 234722,	-- Om'Toya
			}),
			fp(3035, {	-- Hosaas Rest, K'aresh
				["coord"] = { 54.2, 62.8, KARESH },
				["cr"] = 234701,	-- Om'Dodaf
			}),
			fp(3034, {	-- Overlook Zo'Shuul, K'aresh
				["coord"] = { 47.8, 37.3, KARESH },
				["cr"] = 234724,	-- Om'Qaxxi
			}),
			fp(3033, {	-- Shadow Point, K'aresh
				["coord"] = { 42.2, 22.7, KARESH },
				["cr"] = 234719,	-- Lossain
			}),
			fp(3032, {	-- Shan'dorah, K'aresh
				["coord"] = { 60.6, 29.2, KARESH },
				["cr"] = 234721,	-- Sellyna
			}),
			...
			fp(3031, {	-- The Oasis, K'aresh
				["coord"] = { 76.7, 34.9, KARESH },
				["cr"] = 234718,	-- Om'Volt
			}),
		}),
		-- TODO: Temp placement. This will need separate file under Phase Diving header)
