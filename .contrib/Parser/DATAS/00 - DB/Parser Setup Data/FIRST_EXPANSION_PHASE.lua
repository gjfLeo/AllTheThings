-- NOT CURRENTLY USED!
-- These values are currently referenced in the Parser prior to Lua files being consumed

-- Used by Classic-based Parses to filter data based on Phases

-- FIRST_EXPANSION_PHASE = {
