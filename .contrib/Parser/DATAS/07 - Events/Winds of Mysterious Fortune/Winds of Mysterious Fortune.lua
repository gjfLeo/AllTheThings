root(ROOTS.WorldEvents, applyevent(EVENTS.WINDS_OF_MYSTERIOUS_FORTUNE, n(WINDS_OF_MYSTERIOUS_FORTUNE_HEADER, bubbleDownSelf({ ["timeline"] = { ADDED_11_1_5, REMOVED_11_1_5, ADDED_11_1_7, REMOVED_11_2_0_SEASONSTART } }, {
	["maps"] = {
		DRAGON_ISLES,
		EMERALD_DREAM,
		OHNAHRAN_PLAINS,
