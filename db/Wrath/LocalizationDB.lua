...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Collected|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Collected*|r";
...
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Complete*|r";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "Incomplete|r";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Gesammelt|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Gesammelt*|r";
...
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Vollständig*|r";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "Unvollständig|r";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Collecté|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Collecté*|r";
...
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Complet*|r";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "Incomplet|r";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Собрано|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Собрано*|r";
...
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Выполнено*|r";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "Не Выполнено|r";
...
L.ACCOUNT_WIDE_BATTLE_PETS_TOOLTIP = "Las mascotas de compañia pueden coleccionarse con múltiples personajes y realmente requeriría que tuvieses un montón de espacio en las bolsas para poder coleccionarlas todas en un personaje.\n\nRecomendamos mantener esto activado, pero cada quién hace lo que quiere.";
L.ACCOUNT_WIDE_CHARACTERUNLOCKS_TOOLTIP = "Considerar cualquier desbloqueo coleccionado si algun personaje lo ha coleccionado.";
...
L.ACCOUNT_WIDE_TITLES_TOOLTIP = "La mayoría de títulos son rastreados a nivel de toda la cuenta, pero algunos títulos prestigiosos en el WoW estan bloqueados al personaje que los ganó.\n\nActiva esto si no te importa eso y quieres ver esos títulos marcados como Completados en tus personajes secundarios.";
...
L.ACHIEVEMENTS_CHECKBOX = "Logros";
...
L.BATTLE_PETS_CHECKBOX_TOOLTIP = "Activa esta opción para rastrar Mascotas de duelo y acompañantes. Pueden ser encontrados en el mundo abierto o a través de botín de jefe en varias mazmorras y bandas así como vendedores y reputaciones.";
...
L.CELEBRATIONS_LABEL = "Celebraciones y Efectos de Sonido Sound Effects";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Adquirido|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Adquirido*|r";
...
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Completado*|r";
...
L.COMPLETED_SOURCES_CHECKBOX = "Para completado";
L.COMPLETED_SOURCES_CHECKBOX_TOOLTIP = "Activa esta opción si quieres to see completed source locations in the tooltip.\n\nAs an example, if you complete the quest \"Bathran's Hair\" in Ashenvale, the tooltip for Evenar Stillwhisper will no longer show that quest when hovering over him.";
...
L.DEBUG_MODE_TOOLTIP = "Literalmente ... TODAS LAS COSAS EN EL JUEGO. PUNTO. SI, TODO DE TODO. Incluso las cosas no coleccionables como bolsas, consumibles, ingredientes, etc aparecerán en las listas. (Incluído tú! No, en serio. Mira.)\n\nEsto es sólo para propósitos de Depuración. No está pensado para ser usado para el rastreo de completado.\n\nEste modo se salta todos los filtros, incluyendo no obtenibles.";
...
L.DROP_CHANCES_CHECKBOX = "Probabilidad de botón";
...
L.ENABLE_TOOLTIP_INFORMATION_CHECKBOX = "Integraciones con Descripciones emergentes";
...
L.EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP = "Activa esta opción si quieres minimizar automáticamente en la Mini Lista las cabeceras de dificultad que no estan activas cuando entras a una mazmorra o banda.\n\nEjemplo: Minimiza la cabecera de Heroico en una mazmorra de dificultad Normal.";
L.EXPANSION_ID = "Expansión ID";
L.EXPANSION_THINGS_LABEL = "Cosas de expansión";
L.EXPLORATION_CHECKBOX = "Exploración";
L.EXPLORATION_CHECKBOX_TOOLTIP = "Activa esta opción para rastrear el completado de exploración para los mapas exteriores.";
...
L.FOR_UNSORTED_CHECKBOX = "Para no ordenados";
...
L.HEIRLOOMS_CHECKBOX = "Reliquias";
...
L.IGNORE_FILTERS_FOR_BOES_CHECKBOX_TOOLTIP = "Activa este ajuste si quieres ignorar requerimientos de armadura, arma, raza, clase o de profesión para los objetos BoE/BoA items.\n\nSi estás intentando coleccionar cosas para tus personajes secundarios escaneando la Casa de Subastas, este modo puede serte útil.";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "Incompleto|r";
...
L.MODE = "Modo";
L.MODE_EXPLAIN_LABEL = "|cffFFFFFFLo que coleccionas se resume en un modo específico. Activa todas las opciones |c" .. _.DefaultColors.Insane .. "coloreadas|r para desbloquear el |c" .. _.DefaultColors.Insane .. "Modo Demente|r.|r";
L.MODULES = "Módulos";
...
L.MORE_COLORS_CHECKBOX_TOOLTIP = "Activa esta opción si quieres ver mmás colores utilizados para ayudar a distinguir condiciones adicionales de cosas en las listas (i.e. colores de clase, colores de facción, etc.)";
...
L.MOUNTS_CHECKBOX = "Monturas";
L.MOUNTS_CHECKBOX_TOOLTIP = "Activa esta opción para rastrar monturas.\n\nPuedes usarlas para ir a sitios más rápido que corriendo. Quién lo diría!";
...
L.ONLY_RWP_TOOLTIP = "Activa esta opción para rastrear sólamente las transfiguraciones que serán eliminadas del juego en un futuro. Sólo los objetos etiquetados con 'Eliminado en el Parche' ('removed with patch' o 'RWP') cuentan. Si encuentras un objeto sin etiquetar que debería estarlo, dímelo por favor!\n\nPuedes cambiar el tipo de botín que se muestra en la pestaña de Filtros.";
...
L.QUESTS_LOCKED_CHECKBOX = "+Bloqueado";
...
L.REPORT_COLLECTED_THINGS_CHECKBOX_TOOLTIP = "Activa esta opción si quieres to see a message in chat detailing which items you have collected or removed from your collection.\n\nNOTA: This is present because Blizzard silently adds appearances and other collectible items and neglects to notify you of the additional items available to you.\n\nWe recommend you keep this setting on. You will still hear the fanfare with it off assuming you have that option turned on.";
L.REPORT_COMPLETED_QUESTS_CHECKBOX = "Notificar misiones";
L.REPORT_COMPLETED_QUESTS_CHECKBOX_TOOLTIP = "Activa esta opción si quieres ver el QuestID para cualquier misión que aceptes o completes justo después de que pase. (Para notificar errores, propósitos de rastreo, etc)";
...
L.REPORT_UNSORTED_CHECKBOX_TOOLTIP = "Activa esta opción si sólo quieres ver las QuestID si no se han configurado como fuente.";
L.REPORTING_LABEL = "Notificaciones";
...
L.SAVED = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47Conocido|r";
...
L.SHOW_COMPLETED_GROUPS_CHECKBOX_TOOLTIP = "Activa esta opción si quieres ver los grupos completados como cabecera con un porcentaje de completado. Si un grupo no tiene nada relevante para tu clase, este ajuste hará que tambien se muestren estos grupos en el listado.\n\nRecomendamos que desactives este ajuste para conservar espacio en la Mini Lista y te permite ver rápidamente qué te falta de la zona.";
...
L.SHOW_INCOMPLETE_THINGS_CHECKBOX = "Muestra todas las cosas rastreables";
...
L.SHOW_PET_BATTLES_CHECKBOX_TOOLTIP = "Activa este ajuste si quieres ver el contenido que requiere Batallas de mascotas en el juego.";
...
L.SHOW_REMAINING_CHECKBOX_TOOLTIP = "Activa esta opción si quieres ver el numero de objetos pendientes en vez del progreso sobre el tota.";
...
L.SOULBINDCONDUITS_CHECKBOX_TOOLTIP = "Activa esta opción para rastrar Conductos de Shadowlands.";
...
L.WARN_REMOVED_CHECKBOX_TOOLTIP = "Activa esta opción si quieres oír un efecto de sonido de aviso cuando accidentamente vendas o comercies un objeto que te dió una apariencia y que cause que pierdas esa apariencia de tu colección.\n\nPuede ser extremadamente útil si vendes un objeto que tiene un temporizador de compra. El addon te va a decir que has cometido un error.";
...
L.WITH_WRAPPING_CHECKBOX = "Permitir ajuste de línea";
...
L.AUTO_MINI_LIST_CHECKBOX = "Abre automáticamente la mini Lista";
L.BATTLE_PETS_CHECKBOX_TOOLTIP = "Activa esta opción para rastrar Mascotas de duelo y acompañantes. Pueden ser encontrados en el mundo abierto o a través de botín de jefe en varias calabozos y bandas así como vendedores y reputaciones.";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "Aprendido|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "Aprendido*|r";
L.CONFIRM_DELETE = "\n \n¿Estás seguro de que quieres eliminar esto?";
...
L.EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP = "Activa esta opción si quieres minimizar automáticamente en la Mini Lista las cabeceras de dificultad que no estan activas cuando entras a un calabozo o banda.\n\nEjemplo: Minimiza la cabecera de Heroico en un calabozo de dificultad Normal.";
...
L.NOT_COLLECTED = "|cffff9333No aprendido|r";
L.NOTHING_TO_SELECT_FROM = "No se encontró nada para seleccionar aleatoriamente. Si las 'actualizaciones Ad-Hoc' estan habilitadas en los ajustes, la lista principal se tiene que actualizar (/att) antes de usar esta ventana.";
L.ONLY_RWP = "Sólo Removido con el parche";
L.ONLY_RWP_TOOLTIP = "Activa esta opción para rastrear solamente las transfiguraciones que serán eliminadas del juego en un futuro. Sólo los objetos etiquetados con 'Eliminado en el Parche' ('removed with patch' o 'RWP') cuentan. Si encuentras un objeto sin etiquetar que debería estarlo, dímelo por favor!\n\nPuedes cambiar el tipo de botín que se muestra en la pestaña de Filtros.";
...
L.REQUIRES_SKYRIDING = "|cFF00FFDERequiere Cielonautica|r";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.Colors.Completed .. "已收藏|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.Colors.Completed .. "已收藏*|r";
L.COLLECTED_STRING = " 已收藏";
L.COLLECTION_PROGRESS = "收藏进度";
L.COLORS_ICONS = "颜色和图标";
L.COMPLETE = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47已完成|r";
L.COMPLETE_OTHER = "|T" .. _.asset("known_green") .. ":0|t |cff6dce47已完成*|r";
L.COMPLETED_BY = "完成：%s";
...
L.INCOMPLETE = "|T" .. _.asset("incomplete") .. ":0|t |c" .. _.Colors.Completed .. "未完成|r";
...
L.NEW_VERSION_FLAVORS = {"因为万物都饥饿。","下次|cffffaaaa一定|r出无敌！"};
