...
L.PLAYER_TITLE_LORD_QUEEN = "|cffa335eeSeñor Reina %s|r";
...
L.COLLECTED = "|T" .. _.asset("known") .. ":0|t |c" .. _.DefaultColors.Completed .. "Aprendido|r";
L.COLLECTED_APPEARANCE = "|T" .. _.asset("known_circle") .. ":0|t |c" .. _.DefaultColors.Completed .. "Aprendido*|r";
L.CONFIRM_DELETE = "\n \n¿Estás seguro de que quieres eliminar esto?";
